...
#sys.path.append(r"C:\BLS\EvalAI5\Context Extraction")
from  Context_Extraction.keyword_filter import get_filtered_keywords_from_pdf

# Load embedding model
embedding_model = SentenceTransformer("all-MiniLM-L6-v2")

def cluster_keywords(pdf_path, max_clusters=8, use_elbow=True):
    """
...
if __name__ == "__main__":
    ...
    test_pdf = r"C:\BLS\EvalAI5\Uploads\unsupervised.pdf"
    clusters = cluster_keywords(test_pdf, max_clusters=8, use_elbow=True)
